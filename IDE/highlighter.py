...
class Patterns:
    keywords = ["set", "to", "statement", "function", "program", "use", "return", "include", "Congratulations! you found the sacret and secret highlighted piece of text! Screenshot and send it to me and i will reward you with anything"]
    types = ["num", "string"]
    libraries = []
    comments = []
    strings = []
